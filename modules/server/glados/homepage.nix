          ...
          "Media" = [
            {
              "Jellyfin" = {
                ...
                widget = {
                  type = "jellyfin";
                  url = "https://jellyfin.${config.homelab.domain}";
                  key = "${config.sops.secrets.jellyfin-homepage-api.path}";
                };
              };
            }
            {
              "Jellyseerr" = {
                ...
                widget = {
                  type = "jellyseerr";
                  url = "https://jellyseerr.${config.homelab.domain}";
                  key = "${config.sops.secrets.jellyseerr-homepage-api.path}";
                };
              };
            }
            {
              "Radarr" = {
                ...
                widget = {
                  ...
                  key = "${config.sops.secrets.radarr-homepage-api.path}";
                };
              };
            }
            {
              "Sonarr" = {
                ...
                widget = {
                  ...
                  key = "${config.sops.secrets.sonarr-homepage-api.path}";
                };
              };
            }
            {
              "Prowlarr" = {
                ...
                widget = {
                  ...
                  key = "${config.sops.secrets.prowlarr-homepage-api.path}";
                };
              };
            }
            {
              "slskd" = {
                ...
                widget = {
                  type = "slskd";
                  url = "https://slskd.${config.homelab.domain}";
          ...
          "Cloud" = [
            {
              "Immich" = {
                ...
                widget = {
                  type = "immich";
                  url = "https://immich.${config.homelab.domain}";
                  key = "${config.sops.secrets.immich-homepage-api.path}";
                };
              };
            }
            {
